...
const change_like = (id) => {
  ...
  // работает только с булевыми значениями!!!!!
  
  // 3. Передаем обновленное состояние setPosts
  setPosts([...posts])
}
...
const add_comment = (new_comment, post_id ) => {
  ...
  //2. У найденного поста, обращаемся к массиву
  // comments и добавляем в него новыц объект (push)
